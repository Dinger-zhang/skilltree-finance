...
除手动给 Codex 单步任务外，项目可以使用“有监督自主执行”模式。

该模式下，Codex 应读取：

1. `AGENTS.md`
2. `docs/11_CURRENT_STAGE.md`
3. `docs/10_CODEX_AUTONOMOUS_WORKFLOW.md`
...
此模式的目标不是完全无人监管，而是减少用户在网页 ChatGPT、Codex 和终端之间反复复制信息的成本。
